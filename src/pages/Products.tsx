...
const Products: React.FC = () => {
  ...
  const categories = useMemo(() => [
    ...
    { id: 'Course Introduction', name: 'Basics' },
    { id: 'Creative Charts', name: 'Creative Charts' },
    { id: 'Dynamic Charts', name: 'Dynamic Charts' },
    { id: 'Interactive Charts', name: 'Interactive' },
    { id: 'Advanced Formatting', name: 'Advanced' },
    { id: 'Specialized Charts', name: 'Specialized' },
  ...
  return (
    <ProductsWrapper>
      <Container>
        <PageHeader>
          <PageTitle>Excel Data Visualization Mastery Collection</PageTitle>
          <PageSubtitle>Master advanced Excel data visualization with our comprehensive charting fundamentals and advanced technique video library</PageSubtitle>
        </PageHeader>
