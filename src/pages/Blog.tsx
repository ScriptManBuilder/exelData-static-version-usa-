...
const Blog: React.FC = () => {
  ...
  const blogPosts: BlogPostData[] = [
    ...
    {
      id: 10,
      title: "� Coming Soon: Advanced Excel Analytics & Power BI Integration",
  ...
  const popularPosts = [
    ...
    { id: 4, title: "� Advanced Excel Analytics", readTime: "Coming Soon", comingSoon: true }
  ];
