...
const Account: React.FC = () => {
  ...
  const renderCoursesSection = () => {
    ...
    if (!isTestAccount) {
      return (
        <div>
          <SectionTitle>MY EXCEL DATA VISUALIZATION COURSES</SectionTitle>
          ...
          <InfoCard>
            ...
            <EmptyOrdersText style={{ fontSize: '1rem', marginTop: '1rem', opacity: 0.8 }}>
              Once you purchase any Excel Data Visualization course, you'll have lifetime access to all course materials, 
              including videos, downloadable resources, and future updates.
            </EmptyOrdersText>
            <EmptyOrdersButtonWrapper>
              <ShoppingButton as={Link} to="/products" variant="primary">
                Browse Excel Data Visualization Courses
              </ShoppingButton>
            </EmptyOrdersButtonWrapper>
          </InfoCard>
        </div>
    ...
    return (
      <div>
        <div style={{
          ...
          {isSmallMobile ? 'MY EXCEL COURSES' : 'MY EXCEL DATA VISUALIZATION COURSES'}
        </div>
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            textAlign: isSmallMobile ? 'center' : 'left'
          }}>{isSmallMobile ? 'Continue your Excel mastery journey' : 'Continue your Excel Data Visualization mastery journey'}</p>
          <div style={{ 
            display: 'flex', 
      ...
      <Container>
        ...
        <AccountContent>
          ...
          {isMobile && (
            <div style={{
              ...
              <div style={{
                ...
                >
                  📚 {isSmallMobile ? 'My Courses' : 'My Excel Data Visualization Courses'}
                </button>
          ...
          <Sidebar>
            ...
            >
              My Excel Data Visualization Courses
            </SidebarItem>
            <SidebarItem 
