  ...
  return (
    <AboutWrapper>
      <HeroSection ref={heroRef}>
        ...
        <LogoContainer>
          <MainLogo>EXCEL VISUALIZATION</MainLogo>
        </LogoContainer>
        ...
        <Container>
          <ContentContainer>
            ...
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower business professionals worldwide with professional Excel data visualization education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform data concepts into practical Excel visualization skills.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted Excel data visualization courses cover chart creation principles, dashboard design, data analysis techniques, interactive reporting, and business intelligence optimization. Each course is designed with hands-on projects, real-world applications, and professional techniques to help you master Excel data visualization and advance your career in the analytics industry.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our Excel Data Visualization Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive Excel data visualization learning programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
          ...
          <LeadershipContainer>
            ...
            <LeadershipGrid>
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                ...
                <LeaderInfo>
                  <LeaderName>Data Expert</LeaderName>
                  <LeaderTitle>Excel Data Visualization Experts & Educators</LeaderTitle>
                  <LeaderDescription>
                    Passionate about Excel data visualization and dedicated to making Excel visualization education accessible to everyone. 
                    Creates comprehensive video courses to help others learn and master the art of professional data visualization.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in Excel Data Visualization Education</ValueTitle>
                <ValueDescription>
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  Excel data visualization should be accessible to everyone. We create a supportive environment 
                  where analysts from all backgrounds can master data visualization fundamentals.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(30)}>
                ...
                <ValueDescription>
                  We stay current with the latest Excel visualization tools and platforms, 
                  bringing modern data visualization practices directly to our students.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(31)}>
                <ValueIcon>🛡️</ValueIcon>
                <ValueTitle>Professional Data Standards</ValueTitle>
                <ValueDescription>
                  We prioritize creating clean, well-structured data visualizations, teaching not just how to 
                  build charts and dashboards, but how to build them efficiently and professionally.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(32)}>
                ...
                <ValueDescription>
                  Excel data visualization is an evolving field. We foster continuous learning 
              ...
              <ValueCard ref={setElementRef(33)}>
                ...
                <ValueDescription>
                  We focus on practical Excel visualization skills that you can apply immediately 
                  in real projects, from financial dashboards to business reports and interactive analytics.
                </ValueDescription>
              </ValueCard>
            </ValuesGrid>
            ...
            <MissionStatement ref={setElementRef(34)}>
              ...
              <MissionStatementText>
                To empower the next generation of data analysts with world-class education, 
                practical skills, and real-world projects that drive analytics career success. 
                We believe that by making Excel data visualization education accessible and excellent, we can help 
                students create compelling data stories while creating opportunities for everyone 
                to participate in the business intelligence revolution.
              </MissionStatementText>
            </MissionStatement>
          </ValuesContainer>
        </Container>
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalHeader>
            ...
            <ModalSubtitle>Excel Data Visualization Education Experts</ModalSubtitle>
          </ModalHeader>

          <ModalDescription>
            Our team of professional Excel data visualization experts is dedicated to 
            transforming business careers through comprehensive Excel visualization education.
            <br /><br />
            We believe Excel data visualization should be accessible to everyone, from complete beginners to advanced data analysts looking to 
            ...
            with the knowledge and skills needed to create compelling data stories and advance their analytics careers. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately.
            <br /><br />
            Whether you're just starting your Excel data visualization journey or looking to master advanced visualization techniques, 
            our expert team is here to guide you every step of the way. Let's explore the incredible possibilities of professional Excel data visualization together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
